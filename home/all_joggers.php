...
<html>
    ...
    <body>
                ...
                <ul class="mr-auto filter">
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php
                                $sql="SELECT DISTINCT prod_color FROM products1 WHERE prod_subcategory='Joggers' ORDER BY prod_color";
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_fit FROM products1 WHERE prod_subcategory='Joggers' ORDER BY prod_fit";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_material FROM products1 WHERE prod_subcategory='Joggers' ORDER BY prod_material";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_length FROM products1 WHERE prod_subcategory='Joggers' ORDER BY prod_length";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
        ...
        <div class="container"> 
            <h2 style="margin-top:50px;padding-top:25px;color:#212a2f; font-weight:900;">Women's Joggers</h2>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row text-center" id="result">
                        <?php
                            $number=0;
                            $sql="SELECT * FROM products1 WHERE prod_subcategory='Joggers'";
                            $result=$conn->query($sql);
                            while($row = $result->fetch_assoc())
                            {
                                ++$number;
