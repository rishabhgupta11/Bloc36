...
<html>
    ...
    <body>
            ...
            <div class="row no-gutters">
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="prod-women-image">
                        <img id="imagesize" class="prod-women-image-2" src="../images/sportbra-banner.jpg" alt="BLOC36">
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 prod-women-banner" id="bannersize">
                    <div style='padding:16%'>
                        <h1 style='font-size: 1.5rem'> Women's Sport-Bras </h1>
                        <h4 style='font-size: 0.9rem'> The world’s most comfortable sport-bras made from premium materials go perfectly with your daily escapades. </h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="mr-auto filter">
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php
                                $sql="SELECT DISTINCT prod_color FROM products1 WHERE prod_subcategory='Sport-Bra' ORDER BY prod_color";
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_fit FROM products1 WHERE prod_subcategory='Sport-Bra' ORDER BY prod_fit";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_material FROM products1 WHERE prod_subcategory='Sport-Bra' ORDER BY prod_material";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div style="width: 200px; height: auto; overflow-y: auto; overflow-x: hidden;">
                            <?php
                            $sql="SELECT DISTINCT prod_length FROM products1 WHERE prod_subcategory='Sport-Bra' ORDER BY prod_length";
                            $result=$conn->query($sql);
                            while($row=$result->fetch_assoc()){
                            ?>
                                <br>
        ...
        <div class="container"> 
            <h2 style="margin-top:50px;padding-top:25px;color:#212a2f; font-weight:900;">Women's Sport-Bras</h2>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row text-center" id="result">
                        <?php
                            $number=0;
                            $sql="SELECT * FROM products1 WHERE prod_subcategory='Sport-Bra'";
                            $result=$conn->query($sql);
                            while($row = $result->fetch_assoc())
                            {
                                ++$number;
