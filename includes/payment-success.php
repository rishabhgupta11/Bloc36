...
if($_POST)
{
    ...
    $query2 = "UPDATE user_products SET Status='Purchased' WHERE Email='$email' AND Status='ADDED TO CART'";
    mysqli_query($con, $query2) or die(mysqli_error($con));
    
    $totalAmount = $_SESSION['price'];
    $date = date("Y-m-d");
    $query = "SELECT * FROM order_payment WHERE PaymentID='$razorpay_payment_id'";
    $result = mysqli_query($con, $query) or die(mysqli_error($con));
    if(mysqli_num_rows($result)==0)
    {
        $query1 = "INSERT INTO order_payment(referenceCode, Email, PaymentID, totalAmount, paymentType, paymentStatus, Date) VALUES('$referenceCode','$email', '$razorpay_payment_id', '$totalAmount', 'Prepaid', 'Complete', '$date')";
        mysqli_query($con, $query1) or die(mysqli_error($con));
    }    
 
    
    $query3 = "SELECT OrderID FROM order_payment WHERE PaymentID='$razorpay_payment_id'";
    ...
    {
        $query4 = "SELECT ProductID, Quantity, Size FROM user_products WHERE Email='$email' AND Status='Purchased'";
    ...
    $query5 = "SELECT Contact, deliveryAddress, Status FROM user_products WHERE Email='$email' AND Status='Purchased' LIMIT 1";
    ...
    $query7 = "DELETE FROM user_products WHERE Email='$email' AND Status='Purchased'";
    ...
    <body>
        ...
        <div class="container-fluid cart-page">
            <center>
                ...
                <br>
                <h2 style='color:#212a2f;'><b>Payment ID</b> is: <b><?php echo $razorpay_payment_id; ?></b></h2>
                <br>
